...
public class ImageLoader {
    ...
    public static ImageLoader getInstance() {
        if (instance == null) {
            synchronized (ImageLoader.class) {
                if (instance == null) {
                    instance = new ImageLoader(mContext);
                }
            }
        }
    ...
    public void loadImage(@DrawableRes int drawableResId, ImageView imageView) {
        Glide.with(mContext).load(drawableResId).into(imageView);
    }
