...
public class MyBaseExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private ArrayList<ExpanbleGroup> gData;
    private ArrayList<ArrayList<expanbleDemoBean>> iData;
    private Context mContext;

    public MyBaseExpandableListAdapter(ArrayList<ExpanbleGroup> gData, ArrayList<ArrayList<expanbleDemoBean>> iData, Context mContext) {
        this.gData = gData;
        this.iData = iData;
    ...
    @Override
    public ExpanbleGroup getGroup(int groupPosition) {
        return gData.get(groupPosition);
    }

    @Override
    public expanbleDemoBean getChild(int groupPosition, int childPosition) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        itemHolder.img_icon.setImageResource(iData.get(groupPosition).get(childPosition).getAvatar());
