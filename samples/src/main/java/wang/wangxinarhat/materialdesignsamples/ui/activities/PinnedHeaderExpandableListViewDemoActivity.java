...
import wang.wangxinarhat.materialdesignsamples.bean.Group;
...
import wang.wangxinarhat.materialdesignsamples.ui.widget.PinnedHeaderExpandableListView;
import wang.wangxinarhat.materialdesignsamples.ui.widget.StickyLayout;

public class PinnedHeaderExpandableListViewDemoActivity extends Activity implements
    ...
    public static Intent getStartIntent() {
        ...
        intent.setClass(BaseApplication.getApplication(), PinnedHeaderExpandableListViewDemoActivity.class);
        return intent;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pinnedheader_expandable_demo);
            ...
            if (convertView == null) {
                ...
                button.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Toast.makeText(PinnedHeaderExpandableListViewDemoActivity.this, "clicked pos=", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public boolean onChildClick(ExpandableListView parent, View v,
        ...
        Toast.makeText(PinnedHeaderExpandableListViewDemoActivity.this,
