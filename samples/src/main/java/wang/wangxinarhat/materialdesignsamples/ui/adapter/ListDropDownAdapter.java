    ...
    private void fillValue(int position, ViewHolder viewHolder) {
        ...
        if (checkItemPosition != -1) {
            if (checkItemPosition == position) {
                viewHolder.mText.setTextColor(context.getResources().getColor(R.color.app_main_color));
                viewHolder.mText.setBackgroundResource(R.color.grey_white_1000);
            } else {
                viewHolder.mText.setTextColor(context.getResources().getColor(R.color.grey_black_1000));
                viewHolder.mText.setBackgroundResource(R.color.grey_white_1000);
            }
        }
    }
